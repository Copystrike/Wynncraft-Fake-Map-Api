...
public abstract class PlayerEntity extends LivingEntity {
   ...
   public void playSound(SoundEvent soundIn, float volume, float pitch) {
      this.world.playSound(this, this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), soundIn, this.getSoundCategory(), volume, pitch);
   }
               ...
               if (flag5) {
                  ...
                  if (targetEntity instanceof LivingEntity) {
                     ...
                     if (this.world instanceof ServerWorld && f5 > 2.0F) {
                        ...
                        ((ServerWorld)this.world).spawnParticle(ParticleTypes.DAMAGE_INDICATOR, targetEntity.func_226277_ct_(), targetEntity.func_226283_e_(0.5D), targetEntity.func_226281_cx_(), k, 0.1D, 0.0D, 0.1D, 0.2D);
                     }
                  }
   ...
   public void travel(Vec3d p_213352_1_) {
      ...
      if (this.isSwimming() && !this.isPassenger()) {
         ...
         if (d3 <= 0.0D || this.isJumping || !this.world.getBlockState(new BlockPos(this.func_226277_ct_(), this.func_226278_cu_() + 1.0D - 0.1D, this.func_226281_cx_())).getFluidState().isEmpty()) {
   ...
   private void spawnShoulderEntity(CompoundNBT p_192026_1_) {
      if (!this.world.isRemote && !p_192026_1_.isEmpty()) {
         EntityType.loadEntityUnchecked(p_192026_1_, this.world).ifPresent((p_226562_1_) -> {
            ...
            p_226562_1_.setPosition(this.func_226277_ct_(), this.func_226278_cu_() + (double)0.7F, this.func_226281_cx_());
