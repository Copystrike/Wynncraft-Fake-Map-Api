...
public abstract class LivingEntity extends Entity {
   ...
   protected void updateFallState(double y, boolean onGroundIn, BlockState state, BlockPos pos) {
      ...
      if (!this.world.isRemote && this.fallDistance > 3.0F && onGroundIn) {
         ...
         if (!state.isAir(world, pos)) {
            ...
            ((ServerWorld)this.world).spawnParticle(new BlockParticleData(ParticleTypes.BLOCK, state), this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), i, 0.0D, 0.0D, 0.0D, (double)0.15F);
         }
      }
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      if (compound.contains("Team", 8)) {
         ...
         ScorePlayerTeam scoreplayerteam = this.world.func_96441_U().getTeam(s);
         boolean flag = scoreplayerteam != null && this.world.func_96441_U().addPlayerToTeam(this.getCachedUniqueIdString(), scoreplayerteam);
         if (!flag) {
   ...
   protected void constructKnockBackVector(LivingEntity entityIn) {
      entityIn.knockBack(this, 0.5F, entityIn.func_226277_ct_() - this.func_226277_ct_(), entityIn.func_226281_cx_() - this.func_226281_cx_());
   }
   ...
   private boolean canGoThroughtTrapDoorOnLadder(BlockPos pos, BlockState state) {
      if (state.get(TrapDoorBlock.OPEN)) {
         BlockState blockstate = this.world.getBlockState(pos.func_177977_b());
   ...
   protected void func_226295_cZ_() {
      if (!this.isSilent()) {
         ...
         int j = MathHelper.floor(this.func_226278_cu_() - (double)0.2F);
   ...
   private void dismountEntity(Entity entityIn) {
      if (this.world.getBlockState(new BlockPos(entityIn)).getBlock().isIn(BlockTags.field_226154_ad_)) {
         this.setPosition(entityIn.func_226277_ct_(), entityIn.func_226283_e_(1.0D) + 0.001D, entityIn.func_226281_cx_());
      } else if (!(entityIn instanceof BoatEntity) && !(entityIn instanceof AbstractHorseEntity)) {
         double d1 = entityIn.func_226277_ct_();
         double d13 = entityIn.func_226283_e_(1.0D);
         double d3 = entityIn.func_226281_cx_();
         ...
         if (direction != null && direction.getAxis() != Direction.Axis.Y) {
            ...
            for(int[] aint : aint1) {
               ...
               if (this.world.func_226665_a__(this, axisalignedbb2)) {
                  BlockPos blockpos2 = new BlockPos(d11, this.func_226278_cu_(), d12);
                  ...
                  BlockPos blockpos = new BlockPos(d11, this.func_226278_cu_() + 1.0D, d12);
                  if (this.world.func_226665_a__(this, axisalignedbb2.offset(0.0D, 1.0D, 0.0D)) && this.world.getBlockState(blockpos).isTopSolid(this.world, blockpos, this)) {
                     d1 = d11;
   ...
   public void travel(Vec3d p_213352_1_) {
      if (this.isServerWorld() || this.canPassengerSteer()) {
         ...
         if (!this.isInWater() || this instanceof PlayerEntity && ((PlayerEntity)this).abilities.isFlying) {
            if (!this.isInLava() || this instanceof PlayerEntity && ((PlayerEntity)this).abilities.isFlying) {
               ...
               if (this.collidedHorizontally && this.isOffsetPositionInLiquid(vec3d4.x, vec3d4.y + (double)0.6F - this.func_226278_cu_() + d7, vec3d4.z)) {
            ...
            if (this.collidedHorizontally && this.isOffsetPositionInLiquid(vec3d6.x, vec3d6.y + (double)0.6F - this.func_226278_cu_() + d1, vec3d6.z)) {
      ...
      double d5 = this.func_226277_ct_() - this.prevPosX;
      double d6 = this.func_226281_cx_() - this.prevPosZ;
      double d8 = this instanceof IFlyingAnimal ? this.func_226278_cu_() - this.prevPosY : 0.0D;
   ...
   public boolean canEntityBeSeen(Entity entityIn) {
      ...
      Vec3d vec3d1 = new Vec3d(entityIn.func_226277_ct_(), entityIn.func_226280_cw_(), entityIn.func_226281_cx_());
