...
public class WorldRenderer implements AutoCloseable, IResourceManagerReloadListener {
   ...
   protected int getRenderedChunks() {
      ...
      for(WorldRenderer.LocalRenderInformationContainer worldrenderer$localrenderinformationcontainer : this.renderInfos) {
         if (!worldrenderer$localrenderinformationcontainer.renderChunk.func_178571_g().isEmpty()) {
            ++i;
         }
      }
   ...
   private void func_228437_a_(ActiveRenderInfo p_228437_1_, ClippingHelperImpl p_228437_2_, boolean p_228437_3_, int p_228437_4_, boolean p_228437_5_) {
      ...
      ChunkRenderDispatcher.ChunkRender chunkrenderdispatcher$chunkrender = this.viewFrustum.func_178161_a(blockpos);
      int i = 16;
         ...
         if (chunkrenderdispatcher$chunkrender != null) {
            ...
            for(int i1 = -this.renderDistanceChunks; i1 <= this.renderDistanceChunks; ++i1) {
               for(int j1 = -this.renderDistanceChunks; j1 <= this.renderDistanceChunks; ++j1) {
                  ChunkRenderDispatcher.ChunkRender chunkrenderdispatcher$chunkrender1 = this.viewFrustum.func_178161_a(new BlockPos(k + (i1 << 4) + 8, j, l + (j1 << 4) + 8));
   ...
   private ChunkRenderDispatcher.ChunkRender func_181562_a(BlockPos playerPos, ChunkRenderDispatcher.ChunkRender renderChunkBase, Direction facing) {
      ...
      if (MathHelper.abs(playerPos.getX() - blockpos.getX()) > this.renderDistanceChunks * 16) {
         ...
         return MathHelper.abs(playerPos.getZ() - blockpos.getZ()) > this.renderDistanceChunks * 16 ? null : this.viewFrustum.func_178161_a(blockpos);
      } else {
         return null;
      }
   }
   ...
   public void func_228426_a_(MatrixStack p_228426_1_, float p_228426_2_, long p_228426_3_, boolean p_228426_5_, ActiveRenderInfo p_228426_6_, GameRenderer p_228426_7_, LightTexture p_228426_8_, Matrix4f p_228426_9_) {
      ...
      this.mc.world.getChunkProvider().func_212863_j_().tick(Integer.MAX_VALUE, true, true);
      ...
      for(WorldRenderer.LocalRenderInformationContainer worldrenderer$localrenderinformationcontainer : this.renderInfos) {
         List<TileEntity> list = worldrenderer$localrenderinformationcontainer.renderChunk.func_178571_g().getTileEntities();
         if (!list.isEmpty()) {
   ...
   private void func_228441_a_(RenderType p_228441_1_, MatrixStack p_228441_2_, double p_228441_3_, double p_228441_5_, double p_228441_7_) {
      ...
      while(true) {
         ...
         if (!chunkrenderdispatcher$chunkrender.func_178571_g().func_228912_a_(p_228441_1_)) {
   ...
   private void func_228446_b_(ActiveRenderInfo p_228446_1_) {
      ...
      if (this.mc.field_228004_B_ || this.mc.field_228005_C_) {
         ...
         for(WorldRenderer.LocalRenderInformationContainer worldrenderer$localrenderinformationcontainer : this.renderInfos) {
            ...
            if (this.mc.field_228005_C_ && !chunkrenderdispatcher$chunkrender.func_178571_g().isEmpty()) {
               bufferbuilder.begin(1, DefaultVertexFormats.POSITION_COLOR);
               RenderSystem.lineWidth(10.0F);
               int i1 = 0;
               ...
               for(Direction direction2 : Direction.values()) {
                  for(Direction direction1 : Direction.values()) {
                     boolean flag = chunkrenderdispatcher$chunkrender.func_178571_g().isVisible(direction2, direction1);
                     if (!flag) {
                        ++i1;
   ...
   public void addParticle(IParticleData particleData, boolean ignoreRange, boolean minimizeLevel, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
      try {
         ...
         crashreportcategory.func_71507_a("ID", Registry.PARTICLE_TYPE.getKey(particleData.getType()));
         crashreportcategory.func_71507_a("Parameters", particleData.getParameters());
         crashreportcategory.func_189529_a("Position", () -> {
