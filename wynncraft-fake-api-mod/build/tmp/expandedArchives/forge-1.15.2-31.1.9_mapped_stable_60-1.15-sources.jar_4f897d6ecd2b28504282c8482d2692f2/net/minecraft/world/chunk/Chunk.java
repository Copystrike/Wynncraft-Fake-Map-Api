...
public class Chunk extends net.minecraftforge.common.capabilities.CapabilityProvider<Chunk> implements IChunk, net.minecraftforge.common.extensions.IForgeChunk {
   ...
   public Chunk(World worldIn, ChunkPrimer p_i49947_2_) {
      this(worldIn, p_i49947_2_.getPos(), p_i49947_2_.func_225549_i_(), p_i49947_2_.func_196966_y(), p_i49947_2_.getBlocksToBeTicked(), p_i49947_2_.getFluidsToBeTicked(), p_i49947_2_.getInhabitedTime(), p_i49947_2_.getSections(), (Consumer<Chunk>)null);
   ...
   public BlockState setBlockState(BlockPos pos, BlockState state, boolean isMoving) {
      ...
      if (blockstate == state) {
         ...
         if (flag != flag1) {
            this.world.getChunkProvider().func_212863_j_().func_215567_a(pos, flag1);
         }
   ...
   public WorldLightManager getWorldLightManager() {
      return this.world.getChunkProvider().func_212863_j_();
   }
   ...
   public void rescheduleTicks() {
      if (this.blocksToBeTicked instanceof ChunkPrimerTickList) {
         ...
         this.world.getPendingBlockTicks().addAll(((SerializableTickList)this.blocksToBeTicked).func_219499_a());
         this.blocksToBeTicked = EmptyTickList.get();
      }
      ...
      if (this.fluidsToBeTicked instanceof ChunkPrimerTickList) {
         ...
         this.world.getPendingFluidTicks().addAll(((SerializableTickList)this.fluidsToBeTicked).func_219499_a());
         this.fluidsToBeTicked = EmptyTickList.get();
      }
   ...
   public void func_222880_a(ServerWorld p_222880_1_) {
      if (this.blocksToBeTicked == EmptyTickList.<Block>get()) {
         this.blocksToBeTicked = new SerializableTickList<>(Registry.BLOCK::getKey, p_222880_1_.getPendingBlockTicks().getPending(this.pos, true, false));
         this.setModified(true);
      }

      if (this.fluidsToBeTicked == EmptyTickList.<Fluid>get()) {
         this.fluidsToBeTicked = new SerializableTickList<>(Registry.FLUID::getKey, p_222880_1_.getPendingFluidTicks().getPending(this.pos, true, false));
         this.setModified(true);
      }
   ...
   public void setLocationType(Supplier<ChunkHolder.LocationType> p_217314_1_) {
      this.locationType = p_217314_1_;
   }
