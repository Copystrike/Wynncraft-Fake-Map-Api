...
public class BambooBlock extends Block implements IGrowable {
   ...
   public BlockState getStateForPlacement(BlockItemUseContext context) {
      ...
      if (!ifluidstate.isEmpty()) {
         ...
         BlockState blockstate = context.getWorld().getBlockState(context.getPos().func_177977_b());
   ...
   public void func_225534_a_(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      if (!p_225534_1_.isValidPosition(p_225534_2_, p_225534_3_)) {
         ...
         if (p_225534_4_.nextInt(3) == 0 && p_225534_2_.isAirBlock(p_225534_3_.up()) && p_225534_2_.func_226659_b_(p_225534_3_.up(), 0) >= 9) {
            int i = this.getNumBambooBlocksBelow(p_225534_2_, p_225534_3_) + 1;
            if (i < 16) {
               this.grow(p_225534_1_, p_225534_2_, p_225534_3_, p_225534_4_, i);
            }
         }
   ...
   public boolean isValidPosition(BlockState state, IWorldReader worldIn, BlockPos pos) {
      return worldIn.getBlockState(pos.func_177977_b()).isIn(BlockTags.BAMBOO_PLANTABLE_ON);
   }
   ...
   protected void grow(BlockState blockStateIn, World worldIn, BlockPos posIn, Random rand, int p_220258_5_) {
      BlockState blockstate = worldIn.getBlockState(posIn.func_177977_b());
         ...
         if (blockstate.getBlock() == Blocks.BAMBOO && blockstate.get(PROPERTY_BAMBOO_LEAVES) != BambooLeaves.NONE) {
            if (blockstate.getBlock() == Blocks.BAMBOO && blockstate.get(PROPERTY_BAMBOO_LEAVES) != BambooLeaves.NONE) {
               ...
               if (blockstate1.getBlock() == Blocks.BAMBOO) {
                  worldIn.setBlockState(posIn.func_177977_b(), blockstate.with(PROPERTY_BAMBOO_LEAVES, BambooLeaves.SMALL), 3);
   ...
   protected int getNumBambooBlocksBelow(IBlockReader worldIn, BlockPos pos) {
      int i;
      for(i = 0; i < 16 && worldIn.getBlockState(pos.func_177979_c(i + 1)).getBlock() == Blocks.BAMBOO; ++i) {
         ;
      }
