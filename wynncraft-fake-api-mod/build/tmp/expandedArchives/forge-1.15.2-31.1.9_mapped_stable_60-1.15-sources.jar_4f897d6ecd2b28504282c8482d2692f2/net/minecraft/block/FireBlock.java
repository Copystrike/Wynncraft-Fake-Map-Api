...
public class FireBlock extends Block {
   ...
   public void func_225534_a_(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      if (p_225534_2_.getGameRules().getBoolean(GameRules.DO_FIRE_TICK)) {
         ...
         Block block = p_225534_2_.getBlockState(p_225534_3_.func_177977_b()).getBlock();
         BlockState other = p_225534_2_.getBlockState(p_225534_3_.func_177977_b());
               ...
               for(int i1 = -1; i1 <= 1; ++i1) {
                  for(int j1 = -1; j1 <= 4; ++j1) {
                     if (l != 0 || j1 != 0 || i1 != 0) {
                        ...
                        blockpos$mutable.func_189533_g(p_225534_3_).func_196234_d(l, j1, i1);
